...
class TiledLevel extends TiledMap
{
	...
	public function loadObjects(state:states.PlayState)
	{
		for (layer in layers)
		{
	...
	private function loadObject(o:TiledObject, g:TiledObjectLayer, state:states.PlayState)
	{
		var x:Int = o.x;
		var y:Int = o.y;
		...
		switch (o.type.toLowerCase())
		{
			case "player_start":
				...
				var player = new entities.Player(x, y);
				state.player = player;
			...
			case "enemies":
				...
				var enemy = new entities.Enemy(x, y,enemyType);
				state.enemies.add(enemy);
			case "items":
				var itemName = Std.parseInt(o.properties.get("itemName"));
				var itemType =Std.parseInt(o.properties.get("itemType"));
				var item = new entities.Item(x, y, o.name, itemType);
				state.listOfFood.push(o.name);
				state.items.add(item);
			case "receta":
				state.listOfFood.push(o.name);
			case "exit":
				state.exit = new entities.Exit(x, y);					
		}
	}
